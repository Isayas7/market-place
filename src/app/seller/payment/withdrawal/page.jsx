...
const Withrawal = () => {
  ...
  if (sellerLoading || transactionLoading || bankLoading) {
    return (
  ...
  return (
    <div>
      <div className="text-3xl pb-2 font-bold">Withdrawal Form</div>
        ...
        <Card className="w-full h-[640px] flex flex-col items-center p-2 overflow-y-scroll">
          ...
          {transaction?.data?.length !== 0 ? (
            transaction?.data?.map((tran, index) => (
              <div
                key={index}
                className="w-full flex  justify-between items-center p-2 hover:bg-slate-200 hover:dark:bg-mirage-500 cursor-pointer"
              >
                <div className=" ">
